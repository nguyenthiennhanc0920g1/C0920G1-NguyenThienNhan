...
public class HoSoBenhAnEDM {
    ...
    public HoSoBenhAnEDM() {
    }

    public HoSoBenhAnEDM(String maBenhAn, String maBenhNhan, String tenBenhNhan, Date ngayNhapVien, Date ngayXuatVien,

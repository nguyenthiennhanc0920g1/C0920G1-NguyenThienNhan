...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size: xx-large" href="index.html">Home Furama</a>
        </div>
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <%--login/out--%>
                <li>
                    <a href="http://localhost:8085/login.jsp" class="js-search" data-close="true">
                        <span class="text-justify">Log-in</span></a>
                </li>
                <li>
                    <a href="http://localhost:8085" class="js-search" data-close="true">
                        <span class="text-justify">Log-out</span></a>
                </li>
                <!-- #END# login/out -->
                <!-- Notifications -->
                <li class="dropdown">
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="home/images/image_from_ios.jpg" width="48" height="48" alt="User"/>
            </div>
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <%
                        String username2 = (String) session.getAttribute("tendangnhap");
                        if (session != null) {
                            out.print("Hello " + username2);
                        } else {
                            out.print("Hello you");
                        }
                    %>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    <a href="http://vi.thetimenow.com/worldclock.php">
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2020 - 2021 <a href="javascript:void(0);">Stolen by Nhân Nguyễn</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.5
            </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    <div class="icon">
                        <a href="http://localhost:8085/employee">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    <div class="icon">
                        <a href="http://localhost:8085/customer/Request_customer.jsp">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    <div class="icon">
                        <a href="http://localhost:8085/service">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <div class="info-box bg-grey hover-expand-effect">
                    <div class="icon">
                        <a href="http://localhost:8085/contract">
                            <i class="material-icons">person_add</i>
                        </a>
                    </div>
                    <div class="content">
                ...
                <div class="card">
                    ...
                    <div align="center">
                        <table class="table" border="1" cellpadding="5">
                            ...
                            <c:forEach var="customer" items="${listCustomer}">
                                <tr>
                                    ...
                                    <td><c:out value="${customer.phone_number_customer}"/></td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger">
                                            <a href="/users?action=delete&id=${customer.id}">Delete</a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <button type="button" class="btn btn-default">
                            <a href="http://localhost:8085/customer/create.jsp">Add new customer</a>
                        </button>
                    </div>
                </div>
            </div>
